			  		...
			  		<div class="card card-warning">
						...
						<div class="card-body">
							<table id="list-data" class="table table-bordered table-hover">
								...
								@if ($isAllow || in_array('banner.change-status', $allowedRoutes) || in_array('banner.edit', $allowedRoutes) || in_array('banner.delete', $allowedRoutes))
