			  		...
			  		<div class="card card-warning">
						...
						<div class="card-body">
							<table id="list-data" class="table table-bordered table-hover">
								...
								@if ($isAllow || in_array('beneticTurn.change-status', $allowedRoutes) || in_array('beneticTurn.edit', $allowedRoutes) || in_array('beneticTurn.delete', $allowedRoutes))
...
@push('scripts')
@include('admin.benetic_turn.scripts')
@endpush