			  		...
			  		<div class="card card-warning">
						...
						<div class="card-body">
							<table id="list-data" class="table table-bordered table-hover">
								...
								@if ($isAllow || in_array('howItWork.change-status', $allowedRoutes) || in_array('howItWork.edit', $allowedRoutes) || in_array('howItWork.delete', $allowedRoutes))
...
@push('scripts')
@include('admin.how_it_work.scripts')
@endpush