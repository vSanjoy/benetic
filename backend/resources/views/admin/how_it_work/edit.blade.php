                ...
                <div class="col-md-12">
                    <div class="card card-warning">
                        ...
                        {{ Form::open(array(
                                        'method'=> 'POST',
                                        'class' => '',
                                        'route' => ['admin.howItWork.edit-submit', $id],
                                        'name'  => 'updateHowItWorkForm',
                                        'id'    => 'updateHowItWorkForm',
                                        'files' => true,
                                        'autocomplete' => 'off',
                                        'novalidate' => true)) }}
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            @if(file_exists(public_path('/images/uploads/how_it_work/'.$details->image))) 
                                                <embed src="{{ asset('images/uploads/how_it_work/'.$details->image) }}" height=50 />
                                            @endif
                                        </div>
                                        @endif
                                    </div>
