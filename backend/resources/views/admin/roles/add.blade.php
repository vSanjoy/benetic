                        ...
                        {{ Form::open(array(
                                            ...
                                            @foreach($groupRow as $row)
                                                ...
                                                <li>
                                                    <div class="icheck-primary d-inline">
                                                        <input type="checkbox" name="role_page_ids[]" value="{{$row['role_page_id']}}" data-page="{{ $group }}" data-path="{{ $row['path'] }}" data-class="{{ $groupClass }}" data-listIndex="{{$listIndexClass}}" class="setPermission {{ $groupClass }} {{ $subClass }} selectDeselectAll" id="checkboxPrimary_{{$h}}_{{$listOrIndex}}">
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" class="btn bg-gradient-success float-right">
                                    <i class="fas fa-save"></i> @lang('custom_admin.btn_submit')
                                </button>
                            </div>
                        {{Form::close()}}
                    </div>
