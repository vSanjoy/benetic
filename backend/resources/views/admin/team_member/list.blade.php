			  		...
			  		<div class="card card-warning">
						...
						<div class="card-body">
							<table id="list-data" class="table table-bordered table-hover">
								...
								@if ($isAllow || in_array('teamMember.change-status', $allowedRoutes) || in_array('teamMember.edit', $allowedRoutes) || in_array('teamMember.delete', $allowedRoutes))
...
@push('scripts')
@include('admin.team_member.scripts')
@endpush