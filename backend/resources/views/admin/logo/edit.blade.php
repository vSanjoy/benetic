                ...
                <div class="col-md-12">
                    <div class="card card-warning">
                        ...
                        {{ Form::open(array(
                                        'method'=> 'POST',
                                        'class' => '',
                                        'route' => ['admin.logo.edit-submit', $id],
                                        'name'  => 'updateLogoForm',
                                        'id'    => 'updateLogoForm',
                                        'files' => true,
                                        'autocomplete' => 'off',
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        {{-- <span>@lang('custom_admin.label_select_file_dimensions') {{AdminHelper::ADMIN_LOGO_THUMB_IMAGE_WIDTH}}px X {{AdminHelper::ADMIN_LOGO_THUMB_IMAGE_HEIGHT}}px</span> --}}
                                        @if ($details->image != null)
                                        <div class="form-group">
                                            @if(file_exists(public_path('/images/uploads/logo/'.$details->image))) 
                                                <embed src="{{ asset('images/uploads/logo/'.$details->image) }}" widht=120 />
                                            @endif
                                        </div>
                                        @endif
                                    </div>
